function moduleProject1() {
  ...
  authorDate.textContent = `${author} in ${date}`
  ...
  const randomSentence = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomVerb2} our ${randomNoun2} ${randomAdverb2}.`
